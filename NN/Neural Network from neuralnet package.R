...
getNN <- function(data, filename){
  start <- Sys.time()
  nn <- neuralnet::neuralnet(nextMoveDir ~., data, hidden = 10, linear.output = FALSE, threshold = .2)
...
getNN(data_shuffled[2001:3000, ], "nn1"); beepr::beep(3) # 38.0 secs
getNN(data_shuffled[2001:4000, ], "nn2"); beepr::beep(3) # 7.7 mins
getNN(data_shuffled[2001:6000, ], "nn3"); beepr::beep(3) # 2.42 mins
getNN(data_shuffled[2001:10000, ], "nn4"); beepr::beep(3) # 15.7 mins
